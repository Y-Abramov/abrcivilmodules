...
namespace AbrCivil.Modules.Core
{
    ...
    /// <summary>
    /// Дефолты галок и подписи состояний на шаге установки. Снятая галка означает «не трогать»,
    /// а не «удалить» - удаление живёт на отдельной странице утилиты (RemovalPlanner) и в Сторе.
    /// </summary>
